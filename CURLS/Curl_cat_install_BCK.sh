...
/n/bswhealth/b/RMAN_PSFT_NP/o/Curl_cat_install.sh -o Curl_cat_install.sh
chmod u+x Curl_cat_install.sh
ln -sf Curl_cat_install.sh I00
EOC

chmod u+x CURL_Curl_cat_install.sh
ln -fs CURL_Curl_cat_install.sh C00
...
/n/bswhealth/b/RMAN_PSFT_NP/o/lll_X_install.sh -o lll_X_install.sh
chmod u+x lll_X_install.sh
ln -sf lll_X_install.sh I01
EOC

chmod u+x CURL_lll_X_install.sh
ln -fs CURL_lll_X_install.sh C01
...
/n/bswhealth/b/RMAN_PSFT_NP/o/create_gen_env.sh -o create_gen_env.sh
chmod u+x create_gen_env.sh
ln -sf create_gen_env.sh I02
EOC

chmod u+x CURL_create_gen_env.sh
ln -fs CURL_create_gen_env.sh C02
...
ln -fs CURL_create_rman_codes.sh C03
...
ln -fs CURL_patch_admin_stack_install.sh C30
